        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          ...
          <div class="btn-group dropstart ">
            ...
            <ul class="dropdown-menu dropdown-menu-dark">
              <li><a class="dropdown-item" href="../perfil/meu_perfil/perfil_cliente.php">Meu Perfil</a></li>
    ...
    <div class="container py-5">
      ...
      <div class="row">
        <div class="col-lg-12 my-1 p-5 border border-outline-white rounded-5">
          ...
          <div class="field">
            <div class="control">
              <input name="id" type="hidden" value="<?php echo "$row[0]"?>" style="display: none;"class="input is-large">
             </div>
            </div>
            <h3 style="color: silver;" name="nome">Nome: <?php echo "$row[3]"; ?></h3>
            <h3 style="color: silver" name="profissao">Profissão: <?php echo "$row[9]"; ?></h3>
            <h3 style="color: silver" name="profissao">Cidade: <?php echo "$row[11]"; ?> - <?php echo "$row[12]" ?></h3>
            <h3 style=" margin-bottom: 3%; color: silver" name="celular">Telefone: (<?php echo "$row[13]"?>) <?php echo "$row[5]"; ?><br><br>
            <p>
      ...
      $sql_code = "SELECT nome, profissao, carreira, celular, email, id, ddd, cidade, uf FROM prestador_servicos WHERE profissao LIKE '%".$pesquisa_prof."%'";
      $result = mysqli_query($conexao, $sql_code);
      ...
      <div class="row">
        <div class="col-lg-12 my-1 p-5 border border-outline-white rounded-5">
          ...
          <div class="field">
            <div class="control">
              <input name="id" type="hidden" value="<?php echo "$row[5]"?>" style="display: none;"class="input is-large">
             </div>
            </div>
            <h3 style="color: silver;" name="nome">Nome: <?php echo "$row[0]"; ?></h3>
            <h3 style="color: silver" name="profissao">Profissão: <?php echo "$row[1]"; ?></h3>
            <h3 style=" margin-bottom: 3%; color: silver" name="carreira">Cidade: <?php echo "$row[7]"?> - <?php echo "$row[8]"?></h3>
