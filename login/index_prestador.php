                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <div class="btn-group dropstart ">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark">
                            <li><a class="dropdown-item" href="../login/login_prestador.php">Entrar</a></li>
        ...
        <div class="hero-body">
            <div class="container has-text-centered">
                <div class="column is-4 is-offset-4">
                    ...
                    <h3 class="has-text-white">Entre como <span class="title">Prestador</span></h3>
                    <?php
                    ...
                    ?>
                    <div class="box">
                        <form action="login_prestador.php" method="POST">
