...
$email = $_SESSION["user"];
$sql_query = "SELECT nome, celular, email, cidade, uf, ddd FROM cliente_servicos WHERE email = '$email'";
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <div class="btn-group dropstart ">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark">
                            <li><a class="dropdown-item" href="../../pagina_pesquisa/index.php">Voltar</a></li>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-6 px-xl-10">
                                        <div class="bg-secondary d-lg-inline-block py-1-9 px-1-9 px-sm-6 mb-1-9 rounded">
                                            <h3 class="h2 text-white mb-0"><?php echo $row[0]?></h3>
                                        </div>
                                        <ul class="list-unstyled mb-1-9">
                                            <li class="mb-1 mb-xl-3 display-28" style="color: white; font-size: 150%;">Email: <?php echo $row[2]?></li>
                                            <li class="mb-1 mb-xl-3 display-28" style="color: white; font-size: 150%;">Telefone: (<?php echo "$row[5]"?>) <?php echo $row[1]?></li>
                                            <li class="mb-1 mb-xl-3 display-28" style="color: white; font-size: 150%;">Cidade: <?php echo $row[3]?> - <?php echo "$row[4]"?></li>
                                        </ul>
                                        <a href="../../pagina_pesquisa/index.php"><button style="background-color: #C9586C; width:30%; height:100%;" name="contatar"class="btn btn-outline-light" type="submit">Voltar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
