        ...
        <div class="hero-body">
            <div class="container has-text-centered">
                <div class="column is-4 is-offset-4">
                    ...
                    <h3 class="has-text-white"> Cadastre-se como <span class="title">Cliente</span></h3>
                    ...
                    <div class="box">
                        ...
                        <form action="cadastrar_cliente.php" method="POST">
                            ...
                            <label for="cpf" style="float: left; font-size: 20px;">CPF</label>
                            <div class="field">
                                <div class="control">
                                    <input name="cpf" type="number" class="input is-large" placeholder="CPF" required>
                                </div>
                            </div>
