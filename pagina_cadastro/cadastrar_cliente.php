...
$query = "INSERT INTO cliente_servicos (tipo_usuario, senha, nome, email, cpfcnpj, nasc, cidade, uf, ddd, celular)
		  VALUES ('{$tipouser}', '{$senha}','{$nome}', '{$email}', '{$cpf}', '{$nasc}', '{$cidade}', '{$uf}', '{$ddd}', '{$celular}')";
