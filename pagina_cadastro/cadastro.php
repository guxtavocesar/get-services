        ...
        <div class="hero-body">
            <div class="container has-text-centered">
                <div class="column is-4 is-offset-4">
                    ...
                    <h3 class="has-text-white">Cadastrar como: </h3>

                    <a href="cadastro_cliente.php"><button type="submit" class="button is-block is-link is-large is-fullwidth" style="background-color: #C9586C;">Cliente</button></a> <br>
                    <a href="cadastro_prestador.php"><button type="submit" class="button is-block is-link is-large is-fullwidth" style="background-color: #C9586C;">Prestador</button></a>
                </div>
            </div>
        </div>
